...
import com.fourtyfourlights.scoretracker.util.RequestMethod;
import com.fourtyfourlights.scoretracker.util.RestClient;
...
public class Login extends Activity{
    ...
    public void onCreate(Bundle savedInstanceState) {
      ...
      //Use async
        ...
        Log.w(TAG, "UserName: " + sPrefs.getString("password", ""));
        if (sPrefs.getString("password", null) != null){
