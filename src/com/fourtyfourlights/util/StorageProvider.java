...
import com.fourtyfourlights.domain.*;
...
public class StorageProvider {
	...
	private static final String TEAM_INSERT = "insert into " + TEAM_TABLE_NAME+ " (team_name, team_color) values (?,?) ";
	...
	public long teamInsert(String teamName, String teamColor){
		this.teamInsert.bindString(1, teamName);
		this.teamInsert.bindString(2, teamColor);
	...
	public List<Player> getAllPlayersByTeamId(int teamId){
		...
		String q = "select id, player_name, player_number, team_id from " + PLAYER_TABLE_NAME + " where team_id = " + teamId;
		Cursor cursor = this.db.rawQuery(q, null);
